            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-indigo-600 to-purple-600 py-6 px-8">
                    <div class="flex items-center justify-center space-x-3">
                        ...
                        <h2 class="text-2xl font-bold text-white">Join Us Today</h2>
                    </div>
                    <p class="text-indigo-100 text-center mt-2">Create your account to get started</p>
                </div>
                ...
                <div class="py-8 px-8">
                    @if (session('error'))
                        <div
                            class="mb-6 bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-xl flex items-center">
                    ...
                    <form class="space-y-6" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input id="name" name="name" type="text" required
                                    class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 placeholder-gray-400"
                        ...
                        <div class="space-y-2">
                            ...
                            @if ($roles->isEmpty())
                                <p class="text-amber-600 text-sm flex items-center bg-amber-50 px-3 py-2 rounded-lg">
                        ...
                        <!-- Submit Button -->
                        <button type="submit"
                            class="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-3 px-4 rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            Create Account
                        </button>
                    </form>
