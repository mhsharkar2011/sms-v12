                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center space-x-3">
                                                    <a href="{{ route('admin.users.edit', $user) }}"
                                                        class="inline-flex items-center px-3 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors shadow-sm opacity-70 hover:opacity-100"
                                                        title="Edit User">
                                                    ...
                                                    <form action="{{ route('admin.users.destroy', $user) }}" method="POST"
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            class="inline-flex items-center px-3 py-2 border border-red-300 rounded-lg text-sm font-medium text-red-700 bg-white hover:bg-red-50 transition-colors shadow-sm opacity-70 hover:opacity-100"
                                                            title="Delete User">
