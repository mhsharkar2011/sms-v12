                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-gray-900">{{ $guardian->full_name }}
                                                </div>
                                                <div class="text-sm text-gray-500">{{ $guardian->occupation ?? 'N/A' }}
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $guardian->user->email }}</div>
                                        <div class="text-sm text-gray-500">{{ $guardian->user->phone ?? 'N/A' }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            @if ($guardian->students_count > 0)
                                                ...
                                                @endphp
                                                @if ($firstStudent)
                                                    <a href="{{ route('admin.students.show', $firstStudent) }}"
                                                        class="ml-2 text-blue-600 hover:text-blue-900"
                                                        title="View {{ $firstStudent->full_name }}'s profile">
