            ...
            <div class="container mx-auto px-4 py-8">
                <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            <h1 class="text-2xl font-semibold text-gray-900">Exams Management</h1>
                            <p class="mt-1 text-sm text-gray-600">Manage all exams in the system</p>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="term" id="term"
                                        ...
                                        <option value="1" {{ request('term') == '1' ? 'selected' : '' }}>Term 1
                                        </option>
                                        <option value="2" {{ request('term') == '2' ? 'selected' : '' }}>Term 2
                                        </option>
                                        <option value="3" {{ request('term') == '3' ? 'selected' : '' }}>Term 3
                                        </option>
                                    </select>
                                </div>
                                <div>
                        ...
                        <div class="bg-white rounded-lg shadow p-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-semibold text-gray-900">{{ $publishedExams }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="bg-white rounded-lg shadow p-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-semibold text-gray-900">{{ $scheduledExams }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="bg-white rounded-lg shadow p-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-semibold text-gray-900">{{ $cancelledExams }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="ml-4">
                                                        <div class="text-sm font-medium text-gray-900">{{ $exam->name }}
                                                        </div>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900">{{ $exam->schoolClass->name ?? 'N/A' }}
                                                </div>
                                                <div class="text-sm text-gray-500">Section:
                                                    {{ $exam->section->name ?? 'N/A' }}
                                                </div>
                                                <div class="text-sm text-gray-500">Subject:
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex space-x-2">
                                                    ...
                                                    @if (!$exam->is_published)
                                                        <form action="{{ route('admin.exams.publish', $exam) }}"
                                                            method="POST" class="inline">
                                                            @csrf
                                                            <button type="submit"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5" class="px-6 py-8 text-center text-gray-500">
                                                ...
                                                <p class="mt-2 text-sm font-medium text-gray-900">No exams found</p>
                                                <p class="mt-1 text-sm text-gray-500">Get started by creating a new exam.
                                                </p>
                                            </td>
                                        </tr>
                                    @endforelse
