                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($exams as $exam)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $exam->schoolClass->name ?? 'N/A' }}</div>
                                        <div class="text-sm text-gray-500">Section: {{ $exam->section->name ?? 'N/A' }}
                                        </div>
                                        <div class="text-sm text-gray-500">Subject: {{ $exam->subject->name ?? 'N/A' }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
