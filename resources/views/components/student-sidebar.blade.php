<aside class="w-80 bg-gradient-to-b from-white to-gray-50 border-r border-gray-200 h-screen flex flex-col sticky top-0">
    ...
    <div class="p-6 border-b border-gray-200 bg-white">
        <div class="flex items-center space-x-4">
            ...
            <div class="flex-1 min-w-0">
                ...
                <p class="text-xs text-gray-400 mt-1">Grade 10 • Section A</p>
            </div>
        </div>
    </div>
            ...
            <a href="{{ route($item['route']) }}" class="{{ $classes }}">
                ...
                <div class="ml-3 flex-1 min-w-0">
                    <div class="flex items-center justify-between">
                        ...
                        @if ($item['badge'])
                            <span
                                class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium text-white {{ $item['badgeColor'] ?? 'bg-gray-400' }}">
                                {{ $item['badge'] }}
                            </span>
                        @endif
                    </div>
    ...
    <div class="border-t border-gray-200 bg-white p-4 space-y-2">
        ...
        <div class="mt-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs font-medium text-blue-700">Attendance</p>
                    <p class="text-lg font-bold text-blue-900">92%</p>
                </div>
                <div class="text-right">
                    <p class="text-xs font-medium text-indigo-700">GPA</p>
                    <p class="text-lg font-bold text-indigo-900">3.8</p>
                </div>
            </div>
